...
for i in range(0, 360, 2):
    ...
    json.dump(template, open("scenes/1_animation/1.json", "w"))

    # render the frame
    os.system(f"./build/ray scenes/1_animation/1.json scenes/1_animation/frames/{pad(i)}.png")

# make the video
os.system("rm out.gif")
os.system("ffmpeg -framerate 30 -pattern_type glob -i 'scenes/1_animation/frames/*.png' out.gif")